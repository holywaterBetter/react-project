...
const buildMergedValueRow = (label: string, value: string): ExportCellValue[] => {
  ...
  row[ORGANIZATION_COLUMN_INDEX] = label;
  row[UPDATED_AT_COLUMN_INDEX] = value;
...
export const buildOrganizationWorkforceDashboardExportModel = ({
  ...
  merges.push(
    {
      s: { r: headerGroupRowIndex, c: ORGANIZATION_COLUMN_INDEX },
      e: { r: headerGroupRowIndex + 1, c: ORGANIZATION_COLUMN_INDEX }
    },
    {
      s: { r: headerGroupRowIndex, c: UPDATED_AT_COLUMN_INDEX },
      e: { r: headerGroupRowIndex + 1, c: UPDATED_AT_COLUMN_INDEX }
    },
    {
      s: { r: headerGroupRowIndex, c: CATEGORY_COLUMN_INDEX },
      e: { r: headerGroupRowIndex + 1, c: CATEGORY_COLUMN_INDEX }
    },
    {
      s: { r: headerGroupRowIndex, c: METRIC_COLUMN_START_INDEX },
      ...
      merges.push(
        {
          ...
          e: { r: rows.length - 1, c: ORGANIZATION_COLUMN_INDEX }
        },
        {
          s: { r: sectionStartRowIndex, c: UPDATED_AT_COLUMN_INDEX },
          e: { r: rows.length - 1, c: UPDATED_AT_COLUMN_INDEX }
        }
      );
    }
